...
export default function Home() {
  return (
    <>
        ...
        <div className="p-3 flex mob:flex-col m-auto max-w-6xl justify-between items-center">
          <div className="logo mob:border-b mob:border-b-gray-200 flex justify-center items-center">
            ...
            <div className="text flex flex-col justify-start items-start">
              ...
              <p className="text-xs"> Sri Venkateshwara College Of Engineering</p>
          ...
          <div className="links mob:py-3 flex justify-center items-center space-x-5">
            ...
            <Link href="https://www.instagram.com/dscsvce/?hl=en"><div className="cursor-pointer insta">
            ...
            <Link href="https://twitter.com/DscSvce"><div className="cursor-pointer twitter">
            ...
            <Link href="https://medium.com/@dscsvce"><div className="cursor-pointer medium">
      ...
      <div className="  w-full p-2 text-center bg-gray-900 text-gray-300">Devloped By <a href="https://linktr.ee/dscsvce" className="text-orange-400">GDSC SVCE</a> </div>    </>
  )
}
